...
class TableTest {
    ...
    @Test
    void removeCard(){
        table.slotToCard[0] = 80;
        table.cardToSlot[80] = 0;
        table.removeCard(0);
        assertEquals(slotToCard[0], null);
        assertEquals(cardToSlot[80], null);
    }

    @Test
    void placeToken(){
        table.placeCard(30, 2);
        table.tokensOfPlayers[0].clear();
        table.placeToken(0, 2);
        assertEquals(table.tokensOfPlayers[0].contains(2), true);
    }
